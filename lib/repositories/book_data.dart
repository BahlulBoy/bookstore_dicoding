class ListBook {
  static List<Book> listBook = [
    ...
    Book(
      photo:
          'https://cdn.gramedia.com/uploads/picture_meta/2023/8/2/k4bvsikshrkaba58xt3b7b.jpg',
      name: 'Mao 08',
      createdBy: 'TAKAHASHI RUMIKO',
      language: 'Indonesia',
      description:
          'Rumiko Takahashi (高橋 留美子 Takahashi Rumiko; lahir 10 Oktober 1957) adalah mangaka Jepang yang dikenal dengan karya-karyanya Ranma ½, Urusei Yatsura, Inuyasha, Maison Ikkoku, Mermaid Saga, One-Pound Gospel, dan Rinne. Ia adalah salah satu mangaka tersukses dan paling berpengaruh dalam sejarah manga.Takahashi lahir di Niigata, Jepang. Ia mulai membuat manga sejak usia muda, dan karyanya pertama kali diterbitkan pada tahun 1978. Sejak saat itu, ia telah menulis dan menggambar lebih dari 50 judul manga, yang telah diadaptasi menjadi serial anime, film, dan video game.Karya-karya Takahashi dikenal dengan humornya yang segar, karakternya yang menarik, dan ceritanya yang seru. Ia telah memenangkan berbagai penghargaan atas karyanya, termasuk penghargaan Manga Taishō pada tahun 2019.',
      price: 32000,
      yearRelease: 2023,
      page: 192,
      category: Category.comic,
    ...
    Book(
      photo:
          'https://cdn.gramedia.com/uploads/picture_meta/2023/1/27/9pqwznsjkqernyd6xasdjq.jpg',
      name: 'AKASHA : Chainsaw Man 01',
      createdBy: 'Tatsuki Fujimoto',
      language: 'Indonesia',
      description:
    ...
    Book(
      photo:
          'https://cdn.gramedia.com/uploads/picture_meta/2023/2/17/4gih9vzaewkjf8obqznm5n.jpg',
      name: 'Koloni Jawara Sejati',
      createdBy: 'Tanfidz Tammamudin',
      language: 'Indonesia',
      description:
          """“Kalo elu di Jogja, kita kan enggak bisa sering ketemu kayak gini…”Demi mengejar gadis pujaannya, Zaen belajar keras agar bisa lolos seleksi penerimaan mahasiswa di salah satu universitas favorit di Jogja. Meski berhasil diterima, ternyata kehidupannya di kampus tidak berjalan semulus yang ia kira.Zaen harus menghadapi rival cinta tangguh yang sanggup membuat ia kehilangan segalanya. Apakah Zaen berhasil mendapatkan hati gadis tersebut?""",
      price: 38400,
      yearRelease: 2023,
      page: 168,
      category: Category.comic,
    ...
    Book(
      photo:
          'https://cdn.gramedia.com/uploads/items/9789792250756_the_hunger_games_cu_20.jpg',
      name: 'The Hunger Games 1',
      createdBy: 'Suzanne Collins',
      language: 'Indonesia',
      description:
    ...
    Book(
      photo: 'https://cdn.gramedia.com/uploads/items/Alastair_owns_me.jpg',
      name: 'Alastair Owns Me',
      createdBy: 'NISAAFATM',
      language: 'Indonesia',
      description:
    ...
    Book(
      photo:
          'https://cdn.gramedia.com/uploads/items/ID_HCO2015MTH02HTTSPL_B.jpg',
      name: 'How to Talk So People Listen',
      createdBy: 'Sonya Hamlin',
      language: 'English',
      description:
    ...
    Book(
      photo:
          'https://cdn.gramedia.com/uploads/items/71074/thumb_image_normal/BLK_IMI202255236.jpg',
      name: 'Instrumen Moneter Islam',
      createdBy: 'Ferry Syarifuddin',
      language: 'Indonesia',
      description:
          """Beberapa instrumen kebijakan moneter berdasarkan prinsip Islam telah diperkenalkan di berbagai negara untuk mengelola peredaran uang. Penggunaan instrumen moneter ini pun terus berkembang dari waktu ke waktu. Setiap negara memiliki berbagai alat dan instrumen kebijakan moneter yang berbeda-beda dalam menjalankan kebijakan dan mengelola likuiditasnya. Perbedaan kondisi ini disesuaikan dengan struktur kebijakan moneter dan kedalaman pasar keuangan di setiap negara. Selain itu, akad yang digunakan dalam transaksi pun berbeda-beda sesuai dengan karakteristik dan kekhususan instrumen yang digunakan.""",
      price: 161000,
      yearRelease: 2022,
      page: 630,
      category: Category.study,
